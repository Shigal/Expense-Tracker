package com.shigal.springbootmongodbtutorial.config;/*
 *
 * @author Lawshiga
 *
 */
...
import com.shigal.springbootmongodbtutorial.model.ExpenseCategory;
import com.shigal.springbootmongodbtutorial.repository.ExpenseRepository;
import java.math.BigDecimal;
import java.util.ArrayList;
import java.util.List;

import static com.shigal.springbootmongodbtutorial.model.ExpenseCategory.*;

@ChangeLog
public class DatabaseChangeLog {

    @ChangeSet(order = "001", id = "seedDatabase", author = "Shigal")
